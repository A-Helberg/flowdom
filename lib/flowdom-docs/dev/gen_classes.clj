(ns gen-classes
  "Regenerates resources/flowdom/docs/classes.txt — the Tailwind class
  ...
  Run from lib/flowdom-docs:  clojure -M:gen
  Kept in sync by the example app's flowdom-docs.classes-test."
  (:require [clojure.java.io :as io]
            [clojure.string :as str]))

(def ^:private manifest-path "resources/flowdom/docs/classes.txt")
